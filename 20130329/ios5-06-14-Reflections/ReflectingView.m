...
- (void) setupGradient
{
    ...
    if (!gradient)
    {
        ...
        CGColorRef c1 = [[UIColor blackColor] colorWithAlphaComponent:0.1f].CGColor;
    ...
    gradient.position = parent.layer.position;
    gradient.frame = CGRectOffset(gradient.frame, 0, 0.5*(y + height + desiredGap));
